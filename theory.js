...
//# 🧠 Mini Developer Question

//  Before writing the JavaScript:

//  If we select elements like this:

const changeBtn= document.querySelector('#changeBtn');

//? What symbol must always come before an ID selector in querySelector()?
//  This is a small detail but very important when working with DOM selectors.

//  Answer: The symbol used before an ID selector is #.

//! Feedback

//TODO  Correct — # is the symbol used before an ID selector when using querySelector().

//? Why we use #

//  In CSS selectors (which querySelector() uses), different symbols represent different selector types.
...
//  HTML:           <button id="changeBtn">Change</button>
//  JavaScript:     const changeBtn = document.querySelector('#changeBtn');

//  Here:
//  </> Plain text
//  "#changeBtn"
//      ↑
//  Select element with ID = "changeBtn"

//* Example with a class

//  HTML:           <button class="btn">Change</button>
//  JavaScript:     const button = document.querySelector('.btn');
//  Notice the dot (.) for classes.

//? Why querySelector works this way

//  querySelector() uses CSS selector syntax, which means anything you know from CSS works here too:
...
//  This makes it a very powerful DOM selector.


//# Quick developer tip

//  For IDs, developers often use:
...
//  But both approaches are completely valid.


//? Your next step (mini exercise)

//  Try writing the JavaScript for your exercise.

//  Goal:
//  </> Plain text
//  • Button 1 → change the paragraph text
//  • Button 2 → reset the paragraph text
...
//? Think of it like taking a snapshot of the initial state
//  Page loads
//      ↓
//  Take snapshot of original text
//      ↓
//  User interacts with page
//      ↓
//  Reset restores snapshot
//* If the snapshot is taken too late, the original state is already lost.

//# Quick recap of what you mastered in this mini exercise

//? You practiced the core event pattern:
//  select elements
//      ↓
//  store initial state
//      ↓
...
//* That is exactly how small interactive features are built.
